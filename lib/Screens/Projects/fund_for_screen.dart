...
class _FundForScreenState extends State<FundForScreen> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Fund for,", style: TextStyle(fontSize: 28, color: bodyText1), ),

                        Text("Apeadu House", style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Colors.black),  ),
                        SizedBox(
                          height: 20,
                        ),
                        Container(
                          ...
                          child: Row(
                            children: [
                              Text("Funding Target: ", style: TextStyle(fontSize: 16 )),
                              Text("0.00 \$", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900, color: odaPrimary)),
                            ],
                          ),
                        ),
                        SizedBox(
  ...
  void _fundForModal (BuildContext context) {
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Fund For", style: TextStyle(color: Colors.black, fontSize: 20),),
                          ],
                        ),
                      ),
